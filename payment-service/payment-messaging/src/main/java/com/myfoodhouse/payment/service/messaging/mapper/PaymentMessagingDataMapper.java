package com.myfoodhouse.payment.service.messaging.mapper;
...
public class PaymentMessagingDataMapper {
    ...
    public PaymentRequest paymentRequestAvroModelToPaymentRequest(PaymentRequestAvroModel paymentRequestAvroModel) {
        return PaymentRequest.builder()
                ...
                .paymentOrderStatus(com.myfoodhouse.sys.domain.valueobjects.PaymentStatus.valueOf(paymentRequestAvroModel.getPaymentOrderStatus().name()))
                .build();
    }
}
