package com.myfoodhouse.kafka.consumer.config;
...
import com.myfoodhouse.kafka.config.data.KafkaConfigData;
import com.myfoodhouse.kafka.config.data.KafkaConsumerConfigData;
